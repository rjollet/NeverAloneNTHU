"""
Django settings for neveralone project.
...
SECRET_KEY = 'm#a4_j7^rwi--@4^sfbz&4!dt(u_qb6g*@%u)i(gfd1%1j)up9'
...
WSGI_APPLICATION = 'neveralone.wsgi.application'
...
#'http://neo4j:NeverAlone@neo4j:7474/db/data/'
